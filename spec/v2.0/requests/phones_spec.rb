...
RSpec.describe "Phones", type: :request do
  ...
  describe "GET /contacts/1/phones" do
    it "returns http success" do
      get "/contacts/#{@contact.id}/phones?version=2.0", headers: header
  ...
  describe "POST /contacts/1/phone" do
    it "creates a new Phone" do
      post "/contacts/#{@contact.id}/phone?version=2.0", params: {
        data: {
          type: "phones",
          attributes: {
            number: "123456789"
  ...
  describe "PATCH /contacts/1/phone" do
    it "updates an existing Phone" do
      patch "/contacts/#{@contact.id}/phone?version=2.0", params: {
        data: {
          type: "phones",
  ...
  describe "DELETE /contacts/1/phones/1" do
    it "destroys a phone from a contact" do
      delete "/contacts/#{@contact.id}/phones/#{@contact.phones.first.id}?version=2.0",
      headers: header
